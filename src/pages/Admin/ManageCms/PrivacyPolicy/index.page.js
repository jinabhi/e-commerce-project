...
function PrivacyPolicy() {
  ...
  const onSubmit = async (values) => {
    try {
      ...
      if (success) {
        modalNotification({
          type: "success",
          message: t("text.privacyPolicy.updateMessage"),
        });
  ...
  const breadcrumb = [
    ...
    {
      path: "#",
      name: t("text.privacyPolicy.pageName"),
    },
  ];

  return (
    <>
      <MetaTags title={t("text.privacyPolicy.pageName")} />
      <div className="nk-block-head nk-block-head-sm">
        <div className="nk-block-between">
          <PageHeader heading={t("text.privacyPolicy.pageTitle")}>
