...
function Accessibility() {
  ...
  const onSubmit = async (values) => {
    try {
      ...
      if (success) {
        modalNotification({
          type: "success",
          message: t("text.accessibility.updateMessage"),
        });
  ...
  const breadcrumb = [
    ...
    {
      path: "#",
      name: t("text.accessibility.pageName"),
    },
  ];

  return (
    <>
      <MetaTags title={t("text.accessibility.pageName")} />
      <div className="nk-block-head nk-block-head-sm">
        <div className="nk-block-between">
          <PageHeader heading={t("text.accessibility.pageName")}>
