...
function CancellationPolicy() {
  ...
  const onSubmit = async (values) => {
    try {
      ...
      if (success) {
        modalNotification({
          type: "success",
          message: t("text.cancellationPolicy.updateMessage"),
        });
  ...
  const breadcrumb = [
    ...
    {
      path: "#",
      name: t("text.cancellationPolicy.pageName"),
    },
  ];

  return (
    <>
      <MetaTags title={t("text.cancellationPolicy.pageName")} />
      <div className="nk-block-head nk-block-head-sm">
        <div className="nk-block-between">
          <PageHeader heading={t("text.cancellationPolicy.pageTitle")}>
