...
function EditTermsAndCondition() {
  ...
  const onSubmit = async (values) => {
    try {
      ...
      if (success) {
        modalNotification({
          type: "success",
          message: t("text.termsAndCondition.updateMessage"),
        });
  ...
  const breadcrumb = [
    ...
    {
      path: "#",
      name: t("text.termsAndCondition.pageName"),
    },
  ];

  return (
    <>
      <MetaTags title={t("text.termsAndCondition.pageName")} />
      <div className="nk-block-head nk-block-head-sm">
        <div className="nk-block-between">
          <PageHeader heading={t("text.termsAndCondition.pageTitle")}>
