...
export default function ActiveOrdersDetails() {
  ...
  const statusData = [
    {
      orderStatus: textFormatter(ordersData?.status),
      data: [
        {
          ...
          data: [
            ...
            },
            {
              name: "Packed",
              value:
                ordersData?.status === "packed" ||
                ordersData?.status === "pickedUp"
                  ? checkValidDateFormatter(
                      ordersData?.packedOn,
                      dateFormatter(
                        ordersData?.packedOn,
  ...
  const breadcrumb = [
    ...
    {
      path: "#",
      name: t("text.manageOrders.manageOrder"),
    },
    {
    ...
    {
      path: "#",
      name: t("text.manageOrders.orderDetails"),
    },
  ];
  return (
    <>
      <MetaTags title={t("text.manageOrders.activeOrdersDetails")} />
      <div className="nk-block-head nk-block-head-sm">
        <div className="nk-block-between">
          <PageHeader heading={t("text.manageOrders.activeOrdersDetails")}>
